...
### Fixed
- 🐛 **Scheduled notification quality guard** — skip stock and market notifications when all LLM calls fail, and expose `LITELLM_FALLBACK_MODELS` in the daily analysis workflow.
