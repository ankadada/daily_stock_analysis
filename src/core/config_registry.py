...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LITELLM_MODEL": {
        "title": "LiteLLM Model",
        "description": "Primary LiteLLM model in provider/model format.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LITELLM_REASONING_EFFORT": {
        "title": "LiteLLM Reasoning Effort",
        "description": "Optional reasoning effort passed to LiteLLM, such as low, medium, high, or xhigh.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
